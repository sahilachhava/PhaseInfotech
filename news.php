...
$mail->setFrom('$from', 'NewsLetter Susbcription'); // Set the sender of the message.
$mail->addAddress('ask.phaseinfotech@gmail.com', 'Phase Infotech'); // Set the recipient of the message.
$mail->Subject = 'Phase Infotech Newsletter Subscription'; // The subject of the message.
...
$mail->Body = "Hello! Subscription has been submitted by:
Name:"." ".$name."
E-mail:"." ".$from."
