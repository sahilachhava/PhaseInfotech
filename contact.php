...
$mail->setFrom('$from', 'Inquiry'); // Set the sender of the message.
$mail->addAddress('ask.phaseinfotech@gmail.com', 'Phase Infotech'); // Set the recipient of the message.
$mail->Subject = 'Phase Infotech Inquiry'; // The subject of the message.
...
$mail->Body = "Hello! Your contact form has been submitted by:
Name:"." ".$name."
Subject:"." ".$subject."
E-mail:"." ".$from."
Phone:"." ".$phone."
